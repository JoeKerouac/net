...
public class IHttpClientUtil {
     ...
     *             IO异常
     */
    public String executeGet(String url, String resultCharset, String contentType) throws IOException {
        return execute(IHttpGet.builder(url).contentType(
            StringUtils.isEmpty(contentType) ? IHttpRequestBase.CONTENT_TYPE_JSON : contentType), resultCharset);
    }
     ...
     *             IO异常
     */
    public String executePost(String url, String data, String resultCharset, String requestCharset) throws IOException {
    ...
    public String executePost(String url, String data, String resultCharset, String requestCharset, String contentType)
        ...
        builder.entity(data);
        builder.charset(StringUtils.isEmpty(requestCharset) ? IHttpRequestBase.CHARSET : requestCharset);
        builder.contentType(StringUtils.isEmpty(contentType) ? IHttpRequestBase.CONTENT_TYPE_JSON : contentType);
     ...
     *             IO异常
     */
    private InputStream executeAsStream(IHttpRequestBase.Builder<? extends IHttpRequestBase> builder)
        throws IOException {
     ...
     *             IO异常
     */
    public String execute(IHttpRequestBase.Builder<? extends IHttpRequestBase> builder, String resultCharset)
        throws IOException {
        builder.config(new IHttpConfig());
