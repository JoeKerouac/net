...
abstract class TlsPrfGenerator extends KeyGeneratorSpi {
    ...
    final static byte[]         LABEL_EXTENDED_MASTER_SECRET =
            ...
            { 101, 120, 116, 101, 110, 100, 101, 100, 32, 109, 97, 115, 116, 101, 114, 32, 115, 101,
              99, 114, 101, 116 };
    ...
    SecretKey engineGenerateKey0(boolean tls12) {
        ...
        try {
            ...
            byte[] prfBytes = (tls12
                ? doTLS12PRF(secret, labelBytes, spec.getSeed(), n, spec.getPRFHashAlg(),
    ...
    static byte[] doTLS12PRF(byte[] secret, byte[] labelBytes, byte[] seed, int outputLength,
                             String prfHash, int prfHashLength,
    ...
    static byte[] doTLS12PRF(byte[] secret, byte[] labelBytes, byte[] seed, int outputLength,
                             MessageDigest mdPRF, int mdPRFLen,
    ...
    static byte[] doTLS10PRF(byte[] secret, byte[] labelBytes, byte[] seed,
